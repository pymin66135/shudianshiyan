...
HD_PWD='C:/Users/15756/Lab2_Countdown_Timer_Clean/Lab2_Countdown_Timer_Clean.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log countdown_timer_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source countdown_timer_top.tcl
