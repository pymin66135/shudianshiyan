...
HD_PWD='C:/Users/15756/Lab2_Countdown_Timer_Clean/Lab2_Countdown_Timer_Clean.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log countdown_timer_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source countdown_timer_top.tcl -notrace
