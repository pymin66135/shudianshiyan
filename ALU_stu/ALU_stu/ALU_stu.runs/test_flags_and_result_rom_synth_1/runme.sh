...
HD_PWD='E:/workspace/HDL/00YingCai/Test/class3/class_routine/ALU_FULL/ALU_stu.runs/test_flags_and_result_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_flags_and_result_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_flags_and_result_rom.tcl
