...
HD_PWD='F:/FPGA/project/ALU/ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu32_gate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu32_gate.tcl
