//============================================================
// Module: top (V5.0 16-Core) — Pure Verilog-2001
//============================================================
`timescale 1ns/1ps
...
module top #(
    ...
    parameter N_DATA               = 64
,    parameter DONE_PC_CORE00 = 32'h0000030C
,    parameter DONE_PC_CORE01 = 32'h0000030C
,    parameter DONE_PC_CORE02 = 32'h0000030C
,    parameter DONE_PC_CORE03 = 32'h0000030C
,    parameter DONE_PC_CORE04 = 32'h0000030C
,    parameter DONE_PC_CORE05 = 32'h0000030C
,    parameter DONE_PC_CORE06 = 32'h0000030C
,    parameter DONE_PC_CORE07 = 32'h0000030C
,    parameter DONE_PC_CORE08 = 32'h0000030C
,    parameter DONE_PC_CORE09 = 32'h0000030C
,    parameter DONE_PC_CORE10 = 32'h0000030C
,    parameter DONE_PC_CORE11 = 32'h0000030C
,    parameter DONE_PC_CORE12 = 32'h0000030C
,    parameter DONE_PC_CORE13 = 32'h0000030C
,    parameter DONE_PC_CORE14 = 32'h0000030C
,    parameter DONE_PC_CORE15 = 32'h0000030C
)(
    input wire clk_osc,
    input wire rst
);
