...
#          for the V5.2 32-core sorting architecture.
#============================================================
...
#------------------------------------------------------------
set project_name   "mcu_v5_32core_sim"
...
# Create project
#------------------------------------------------------------
create_project $project_name $project_dir -part xc7k160tffg676-2
...
# Set simulation top
#------------------------------------------------------------
set_property top tb_top_v5_32core [get_filesets sim_1]
