//============================================================
// Module: control_unit (V3.5 + Branch)
// Description:
//   Decode ARM A32 subset for sorting-network cores.
//   V3.5+BRANCH: B instruction support added — branch output drives
//         PC mux in mcu_top. BL is also supported (branch taken,
//         but link register write-back is NOT implemented).
//
//   Branch instructions (B/BL) are decoded with branch=1.
//============================================================
...
always @(*) begin
    ...
    if (op27_25 == 3'b101) begin
        // B / BL — branch taken, no link-register write-back
        instr_class = CLASS_INV;
        reg_write   = 1'b0;
        mem_write   = 1'b0;
        mem_to_reg  = 1'b0;
