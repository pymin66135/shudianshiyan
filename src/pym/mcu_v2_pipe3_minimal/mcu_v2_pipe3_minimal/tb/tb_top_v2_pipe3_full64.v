//============================================================
// Testbench: tb_top_v2_pipe3_full64
// Description:
...
top #(
   ...
   .PROGRAM_FILE("C:/Users/15756/Downloads/mcu_v2_pipe3_minimal/sort64_signed.hex"),
    .PROGRAM_FROM_FILE    (0),                   // Enable loading from hex file
    .INSTR_ROM_ADDR_WIDTH (8),
    .DATA_MEM_ADDR_WIDTH  (8),
    .DONE_PC              (32'h00000168),        // Set to the actual end PC of your 64-sort program
    .N_DATA               (64)
) dut (
    .clk_osc (clk_osc),
    .rst     (rst)
...
initial begin
    ...
    if (errors == 0) begin
        $display("========================================");
        $display("V2 PIPE3 TOP FULL 64-DATA TEST PASSED.");
        $display("========================================");
    end else begin
        $display("========================================");
        $display("V2 PIPE3 TOP FULL 64-DATA TEST FAILED: errors = %0d", errors);
        $display("========================================");
    end
