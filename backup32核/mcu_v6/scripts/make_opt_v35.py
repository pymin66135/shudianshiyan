...
"""
========================================================================
V5.1 16-Core Sort Program Generator - safe NOP gap (纯 global_rf)
========================================================================
...
def main():
    N_TOTAL = 64
    N_CORES = 16
    SAFE_SLOT_GAP = 1  # V5.1: one NOP after every CAS/dummy slot to avoid global_rf same-cycle RAW
        ...
        for i in range(0, len(lp), N_CORES):
            for c in range(N_CORES):
                if i + c < len(lp):
                    ...
                    core_instrs[c].extend([0xE1A00000] * SAFE_SLOT_GAP)
                else:
